...
export const mockAlerts: Alert[] = [
  {
    ...
    escalated: false,
    riskIndicators: ['Velocity spike 4x', 'No history of large transfers', 'Account active for < 30 days'],
    accountId: 'ACC-8812-9901',
  ...
  },
  {
    ...
    escalated: false,
    riskIndicators: ['New device registered', 'High transaction amount', 'Device not previously seen', 'Unusual transaction behaviour'],
    accountId: 'ACC-7731-0192',
    accountStatus: 'ACTIVE',
    caseId: 'CASE-2026-1042',
    caseTitle: 'New Device Investigation',
    caseStatus: 'OPEN'
  }
];
