      ...
      >
        ...
        <div className="p-4 border-t border-border bg-card flex flex-col gap-2">
          <button 
            ...
            onClick={() => alert('Investigation started')}
          >
            Investigate
          </button>
          <div className="flex gap-2">
            ...
            <button 
              className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/80 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" 
